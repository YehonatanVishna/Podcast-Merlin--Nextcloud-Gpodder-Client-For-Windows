...
namespace Podcast_Merlin_Uwp
{
    ...
    sealed partial class App : Application
    {
        ...
        private void OnSuspending(object sender, SuspendingEventArgs e)
        {
            try
            {
                var player = PodMerForWinUi.MainWindow.mediaPlayer_with_poster;
                if (player.ShowLastPlayed != null)
                {
                    PodMerForWinUi.Sync.SyncService.SendAction(player.ShowLastPlayed, ((int)player.Player.MediaPlayer.PlaybackSession.Position.TotalSeconds)).Wait();
                }
